...
def get_friends_listening_now(user_id: str) -> list[dict]:
    ...
    # "Listening now" means friends who have listened *today* (this calendar day),
    # not within a rolling 24-hour window — so the cutoff is the start of today (UTC),
    # not 24 hours ago. A rolling window would keep last night's plays alive until the
